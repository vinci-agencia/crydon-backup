    ...
    $(document).ready(function(){
        $('#btn_finish').click(function(){
            ...
            if ($("#a2_5:checked").length == 0){
                $('#dis').slideDown().html('<span id="error">Por favor Preencha a opção "2.5 - Qualidade do produto:"</span>');
                return false;
            }
...
<div class="col-md-12" class="navbar-left">
 ...
 <!--2.5-->
        ...
        <div id="question_q2" class="survey-q surveyQuestion radio label_q2  ">
            <div class="question titulopage survey-q-question">
                <h2 title="Pergunta" class="survey-q-question-text"> 7 - Preço do produto:</h2>
            </div>
            <!-- /.question -->
            ...
            <div class="answers survey-q-answers">
                <table class="grid survey-q-grid survey-q-grid-borders"
                    ...
                    <tr class="legend colGroup">
                        ...
                        <th colspan="5" id="q2_cg1"
                            class="survey-q-grid-collegend survey-q-grid-group-collegend customRight">
                            <span style="font-size: medium;">Considerar preço comparado a Concorrência.</span>
                        </th>
...
if ((isset($_POST['a1_1'])) AND (isset($_POST['a1_2'])) AND (isset($_POST['a1_6'])) AND (isset($_POST['a1_7'])) AND (isset($_POST['a2_2'])) AND (isset($_POST['a2_4'])) AND (isset($_POST['a2_5'])) AND (isset($_POST['a3_2'])) AND (($_POST['a1_1'] !== "")) AND (($_POST['a1_2'] !== "")) AND (($_POST['a1_6'] !== "")) AND (($_POST['a1_7'] !== "")) AND (($_POST['a2_2'] !== "")) AND (($_POST['a2_4'] !== "")) AND (($_POST['a2_5'] !== ""))) {
    ...
    $sql_insert = "INSERT INTO pesquisa (atend_telefone,atend_representante,preco_produto,prazo_entrega,suporte_tecnico,qualidade_produto,preco_comparado,equip_adquirido,uf,ano) VALUES ('$a1_1','$a1_2','$a1_6','$a1_7','$a2_4','$a2_2','$a2_5','$a3_2','$ufBanco','$periodo')";
    ...
    $m = '
    	<html>
    		...
    		<tr>
    		  ...
    		  <tr>
    			<td>
    				<b>1.3- Preço do produto considerando custo x beneficio:</b>
    			</td>
    		  </tr>
    		  <tr>
    			<td>
              ...
              <tr>
    			<td>
    				<b> 1.7 - Preço do produto comparado com a concorrência:</b>
    			</td>
    		  </tr>
    		  <tr>
    			<td>
