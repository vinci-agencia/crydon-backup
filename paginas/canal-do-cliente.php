...
<div class="container" id="blog">
    <div class="box_titulo" id="titulo_blog">
        <div class="box_titulo_texto">
            <h1>CANAL DO CLIENTE</h1>
        </div>
    </div>
    <div class="conteudo-pagina">
        <div class="row">
            <div class="col-md-12" id="categorias-blog">
                <a href="<?php echo $_SESSION['url'].$lang.'/canal-do-cliente/0/4';?>"><img src="<?php echo $_SESSION['url']; ?>images/receitas.png" alt="Receitas" /></a>
                <a href="<?php echo $_SESSION['url'].$lang.'/canal-do-cliente/0/1';?>"><img src="<?php echo $_SESSION['url']; ?>images/dicas.png" alt="Dicas" /></a>
                <a href="<?php echo $_SESSION['url'].$lang.'/canal-do-cliente/0/2';?>"><img src="<?php echo $_SESSION['url']; ?>images/eventos.png" alt="Eventos" /></a>
                <a href="<?php echo $_SESSION['url'].$lang.'/canal-do-cliente/0/3';?>"><img src="<?php echo $_SESSION['url']; ?>images/noticias.png" alt="Notícias" /></a>
				<a href="<?php echo $_SESSION['url'].$lang.'/canal-do-cliente/0/5';?>"><img src="<?php echo $_SESSION['url']; ?>images/videos.png" alt="Vídeos" /></a>
  ...
  <img src="<?php echo $_SESSION['url']; ?>images/cat_blog.png">-->
				<a href="<?php echo $_SESSION['url'].$lang.'/canal-do-cliente/0/6';?>"><img src="<?php echo $_SESSION['url']; ?>images/faq_blog.png" alt="faq" /></a>
</a>
            ...
            ?>
                <div class="lista-blog">
                    <div class="col-md-7">
                        ...
                        <a href="<?php echo $_SESSION['url'].$lang.'/canal-do-cliente/post/'.$id;?>">Saiba mais</a>
                    </div>
                    <div class="col-md-5">
