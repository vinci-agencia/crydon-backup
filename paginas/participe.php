...
<div class="container" id="participe">
        ...
        <div class="col-md-12" style="background-color: #fff; padding: 20px; margin-bottom: 30px;">
            ...
            foreach (consulta("select texto_" . $lang . " from contato order by id desc LIMIT 1") as $contato) {
                ...
                if ($lang == 'pt') {
                    ...
                    if (!isset($_GET['local'])) {
                        ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14702.176803649589!2d-43.24020100000001!3d-22.928954!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x997e119d008a3f%3A0x2939bd70fa329b9!2sAv.+Maracan%C3%A3%2C+1249+-+Tijuca%2C+Rio+de+Janeiro+-+RJ%2C+20511-000!5e0!3m2!1spt-BR!2sbr!4v1525693982582" width="100%" height="183" frameborder="0" style="border:0" allowfullscreen></iframe>
                                </div>
                            </div>
                    ...
                    <form class="form-faleconosco" id="form_contato" action="" name="contato" method="post" onsubmit="return validaForm()">

                        
                        <br/>
                        <div class="row">
                        <div class="col-md-6">
                     <!--   <div class="col-md-12" id="area_atuacao">
                            <label>Local para demostração</label>
                            <select class="form-control" name="local_demostracao" id="area_atuacao_select">
                        ...
                        <div class="col-md-12" id="area_atuacao">
                            ...
                            <select class="form-control" name="area_atuacao" id="area_atuacao_select">
                                <option class="form-control" value="">Selecione</option>
                                <?php
                                $atuacao = array(1 => "Representante comercial", 2 => "Loja de Equipamento", 3 => "Bar"
                ...
                <div class="col-md-6">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control telefone" id="telefone" maxlength="15" name="telefone"/>
                    </div>
                    <div class="col-md-12">
                        <label>Email</label>
                        ...
                        <input type="submit" class="btEnviar btn btn-success btn-lg" value="Enviar"/>
                        <br/>
                    </form>
                    <?php
                } else if ($lang == 'es') {
...
if ($_POST['nome'] != "") {
    ...
    try {
        ...
        $mail->AddBCC('marketing@croydon.com.br', 'Marketing','mkt02@croydon.com.br','mkt02'); // C?pia Oculta
