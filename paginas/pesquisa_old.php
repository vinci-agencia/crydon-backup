    ...
    $(document).ready(function(){
        $('#btn_finish').click(function(){
            ...
            if ($("#a1_1:checked").length == 0){
                $('#dis').slideDown().html('<span id="error">Por favor Preencha a opção "1.1 - Telefone, fax e E-mail:"</span>');
                return false;
            }
            ...
            if ($("#a1_3:checked").length == 0){
                $('#dis').slideDown().html('<span id="error">Por favor Preencha a opção "1.3 - Vendas (atendimento interno):"</span>');
                return false;
            }
            if ($("#a1_4:checked").length == 0){
                $('#dis').slideDown().html('<span id="error">Por favor Preencha a opção "1.4 - Catálogo/site:"</span>');
                return false;
            }
            if ($("#a1_5:checked").length == 0){
                $('#dis').slideDown().html('<span id="error">Por favor Preencha a opção "1.5 - Facilidade em realizar negócios:"</span>');
                return false;
            }
            ...
            if ($("#a1_8:checked").length == 0){
                $('#dis').slideDown().html('<span id="error">Por favor Preencha a opção "1.8 - Assistência pós-venda:"</span>');
                return false;
            }
            if ($("#a1_9:checked").length == 0){
                $('#dis').slideDown().html('<span id="error">Por favor Preencha a opção "1.9 - Atendimento as emergências:"</span>');
                return false;
            }
            if ($("#a2_1:checked").length == 0){
                $('#dis').slideDown().html('<span id="error">Por favor Preencha a opção "2.1 - Nível tecnológico:"</span>');
                return false;
            }
            if ($("#a2_2:checked").length == 0){
                $('#dis').slideDown().html('<span id="error">Por favor Preencha a opção "2.2 - Suporte técnico - (Engenharia):"</span>');
                return false;
            }
            if ($("#a2_3:checked").length == 0){
                $('#dis').slideDown().html('<span id="error">Por favor Preencha a opção "2.3 - Atendimento as especificações:"</span>');
                return false;
            }
            ...
            if ($("#a2_5:checked").length == 0){
                $('#dis').slideDown().html('<span id="error">Por favor Preencha a opção "2.5 - Embalagem e acondicionamento:"</span>');
                return false;
            }
            if ($("#a2_6:checked").length == 0){
                $('#dis').slideDown().html('<span id="error">Por favor Preencha a opção "2.6 - Transporte:"</span>');
                return false;
            }
            if ($("#a3_1:checked").length == 0){
                $('#dis').slideDown().html('<span id="error">Por favor Preencha a opção "3.1 - Você recomendaria nossos produtos e serviços?"</span>');
                return false;
            }
           /*if ($("#3_2:checked").length == 0){
                $('#dis').slideDown().html('<span id="error">Por favor Preencha a opção "3.2 - Quantos equipamentos sua empresa adquire mensalmente?"</span>');
                return false;
            }*/
            if ($("#empresa").length == 0){
...
foreach (consulta("select texto_" . $lang . " from contato order by id desc LIMIT 1") as $contato) {
    ...
    if ($lang == 'pt') {
        ...
        <p class="texto_internas">PESQUISA DE SATISFAÇÃO DO CLIENTE.</p>
        <br/><br/>
                ...
                <table class="grid survey-q-grid survey-q-grid-borders"
                    ...
                    <tr class="even colCount-11">
                        ...
                        <td headers="q2_c1 q2_cg1" style="display: none"
                            ...
                            <input type="radio" name="a1_1" id="a1_1" value="0"/>
                        </td>
                        <td headers="q2_c2 q2_cg1"
                            class="element groupingRows customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a1_1" id="a1_1" value="1"/>
                        </td>
                        <td headers="q2_c3 q2_cg2"
                            class="element groupingRows customLeft customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a1_1" id="a1_1" value="2"/>
                        </td>
                        <td headers="q2_c4 q2_cg2"
                            class="element groupingRows customLeft customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a1_1" id="a1_1" value="3"/>
                        </td>
                        <td headers="q2_c5 q2_cg2"
                            class="element groupingRows customLeft customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a1_1" id="a1_1" value="4"/>
                        </td>
        ...
        <div id="question_q2" class="survey-q surveyQuestion radio label_q2  ">
            <div class="question titulopage survey-q-question">
                <h2 title="Pergunta" class="survey-q-question-text">1.2 - Representante (atendimento externo):</h2>
            </div>
            <!-- /.question -->
            ...
            <div class="answers survey-q-answers">
                <table class="grid survey-q-grid survey-q-grid-borders"
                    ...
                    <tr class="even colCount-11">
                        ...
                        <td headers="q2_c1 q2_cg1" style="display: none"
                            class="element groupingRows customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a1_2" id="a1_2" value="0"/>
                        </td>
                        <td headers="q2_c2 q2_cg1"
                            class="element groupingRows customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a1_2" id="a1_2" value="1"/>
                        </td>
                        <td headers="q2_c3 q2_cg2"
                            class="element groupingRows customLeft customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a1_2" id="a1_2" value="2"/>
                        </td>
                        <td headers="q2_c4 q2_cg2"
                            class="element groupingRows customLeft customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a1_2" id="a1_2" value="3"/>
                        </td>
                        <td headers="q2_c5 q2_cg2"
                            class="element groupingRows customLeft customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a1_2" id="a1_2" value="4"/>
                        </td>
        ...
        <div id="question_q2" class="survey-q surveyQuestion radio label_q2  ">
            <div class="question titulopage survey-q-question">
                <h2 title="Pergunta" class="survey-q-question-text"> 1.3 - Vendas (atendimento interno):</h2>
            </div>
            <!-- /.question -->
            ...
            <div class="answers survey-q-answers">
                <table class="grid survey-q-grid survey-q-grid-borders"
                    ...
                    <tr class="legend colGroup">
                        ...
                        <th colspan="5" id="q2_cg1"
                            class="survey-q-grid-collegend survey-q-grid-group-collegend customRight">
                            <span style="font-size: medium;">Considerar a eficiência e a rapidez ao atendimento dos Pedidos e Reclamações.</span>
                        </th>
                    ...
                    <tr class="even colCount-11">
                        ...
                        <td headers="q2_c1 q2_cg1" style="display: none"
                            class="element groupingRows customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a1_3" id="a1_3" value="0"/>
                        </td>
                        <td headers="q2_c2 q2_cg1"
                            class="element groupingRows customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a1_3" id="a1_3" value="1"/>
                        </td>
                        <td headers="q2_c3 q2_cg2"
                            class="element groupingRows customLeft customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a1_3" id="a1_3" value="2"/>
                        </td>
                        <td headers="q2_c4 q2_cg2"
                            class="element groupingRows customLeft customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a1_3" id="a1_3" value="3"/>
                        </td>
                        <td headers="q2_c5 q2_cg2"
                            class="element groupingRows customLeft customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a1_3" id="a1_3" value="4"/>
                        </td>
        ...
        <div id="question_q2" class="survey-q surveyQuestion radio label_q2  ">
            <div class="question titulopage survey-q-question">
                <h2 title="Pergunta" class="survey-q-question-text"> 1.4 - Catálogo/site:</h2>
            </div>
            <!-- /.question -->
                ...
                <table class="grid survey-q-grid survey-q-grid-borders"
                    ...
                    <tr class="legend colGroup">
                        ...
                        <th colspan="5" id="q2_cg1"
                            class="survey-q-grid-collegend survey-q-grid-group-collegend customRight">
                            <span
                                style="font-size: medium;">Considerar qualidade e conteúdo técnico disponibilizado.</span>
                        </th>
                    ...
                    <tr class="even colCount-11">
                        ...
                        <td headers="q2_c1 q2_cg1" style="display: none"
                            class="element groupingRows customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a1_4" id="a1_4" value="0"/>
                        </td>
                        <td headers="q2_c2 q2_cg1"
                            class="element groupingRows customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a1_4" id="a1_4" value="1"/>
                        </td>
                        <td headers="q2_c3 q2_cg2"
                            class="element groupingRows customLeft customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a1_4" id="a1_4" value="2"/>
                        </td>
                        <td headers="q2_c4 q2_cg2"
                            class="element groupingRows customLeft customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a1_4" id="a1_4" value="3"/>
                        </td>
                        <td headers="q2_c5 q2_cg2"
                            class="element groupingRows customLeft customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a1_4" id="a1_4" value="4"/>
                        </td>
        ...
        <div id="question_q2" class="survey-q surveyQuestion radio label_q2  ">
            <div class="question titulopage survey-q-question">
                <h2 title="Pergunta" class="survey-q-question-text"> 1.5 - Facilidade em realizar negócios:</h2>
            </div>
            <!-- /.question -->
                ...
                <table class="grid survey-q-grid survey-q-grid-borders"
                    ...
                    <tr class="legend colGroup">
                        ...
                        <th colspan="5" id="q2_cg1"
                            class="survey-q-grid-collegend survey-q-grid-group-collegend customRight">
                            <span
                                style="font-size: medium;">Considerar a flexibilidade, a transparência e o interesse.</span>
                        </th>
                    ...
                    <tr class="even colCount-11">
                        ...
                        <td headers="q2_c1 q2_cg1" style="display: none"
                            class="element groupingRows customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a1_5" id="a1_5" value="0"/>
                        </td>
                        <td headers="q2_c2 q2_cg1"
                            class="element groupingRows customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a1_5" id="a1_5" value="1"/>
                        </td>
                        <td headers="q2_c3 q2_cg2"
                            class="element groupingRows customLeft customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a1_5" id="a1_5" value="2"/>
                        </td>
                        <td headers="q2_c4 q2_cg2"
                            class="element groupingRows customLeft customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a1_5" id="a1_5" value="3"/>
                        </td>
                        <td headers="q2_c5 q2_cg2"
                            class="element groupingRows customLeft customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a1_5" id="a1_5" value="4"/>
                        </td>
        ...
        <div id="question_q2" class="survey-q surveyQuestion radio label_q2  ">
            <div class="question titulopage survey-q-question">
                <h2 title="Pergunta" class="survey-q-question-text">1.6- Preço do produto:</h2>
            </div>
            <!-- /.question -->
            ...
            <div class="answers survey-q-answers">
                <table class="grid survey-q-grid survey-q-grid-borders"
                    ...
                    <tr class="even colCount-11">
                        ...
                        <td headers="q2_c1 q2_cg1" style="display: none"
                            class="element groupingRows customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a1_6" id="a1_6" value="0"/>
                        </td>
                        <td headers="q2_c2 q2_cg1"
                            class="element groupingRows customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a1_6" id="a1_6" value="1"/>
                        </td>
                        <td headers="q2_c3 q2_cg2"
                            class="element groupingRows customLeft customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a1_6" id="a1_6" value="2"/>
                        </td>
                        <td headers="q2_c4 q2_cg2"
                            class="element groupingRows customLeft customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a1_6" id="a1_6" value="3"/>
                        </td>
                        <td headers="q2_c5 q2_cg2"
                            class="element groupingRows customLeft customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a1_6" id="a1_6" value="4"/>
                        </td>
        ...
        <div id="question_q2" class="survey-q surveyQuestion radio label_q2  ">
            <div class="question titulopage survey-q-question">
                <h2 title="Pergunta" class="survey-q-question-text"> 1.7 - Cumprimento dos prazos de entrega:</h2>
            </div>
            <!-- /.question -->
            ...
            <div class="answers survey-q-answers">
                <table class="grid survey-q-grid survey-q-grid-borders"
                    ...
                    <tr class="legend colGroup">
                        ...
                        <th colspan="5" id="q2_cg1"
                            class="survey-q-grid-collegend survey-q-grid-group-collegend customRight">
                            <span style="font-size: medium;">Considerar a pontualidade nas entregas dos Pedidos (nem antes nem depois).</span>
                        </th>
                    ...
                    <tr class="even colCount-11">
                        ...
                        <td headers="q2_c1 q2_cg1" style="display: none"
                            class="element groupingRows customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a1_7" id="a1_7" value="0"/>
                        </td>
                        <td headers="q2_c2 q2_cg1"
                            class="element groupingRows customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a1_7" id="a1_7" value="1"/>
                        </td>
                        <td headers="q2_c3 q2_cg2"
                            class="element groupingRows customLeft customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a1_7" id="a1_7" value="2"/>
                        </td>
                        <td headers="q2_c4 q2_cg2"
                            class="element groupingRows customLeft customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a1_7" id="a1_7" value="3"/>
                        </td>
                        <td headers="q2_c5 q2_cg2"
                            class="element groupingRows customLeft customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a1_7" id="a1_7" value="4"/>
                        </td>
        ...
        <div id="question_q2" class="survey-q surveyQuestion radio label_q2  ">
            <div class="question titulopage survey-q-question">
                <h2 title="Pergunta" class="survey-q-question-text"> 1.8 - Assistência pós-venda:</h2>
            </div>
            <!-- /.question -->
            ...
            <div class="answers survey-q-answers">
                <table class="grid survey-q-grid survey-q-grid-borders"
                    ...
                    <tr class="legend colGroup">
                        ...
                        <th colspan="5" id="q2_cg1"
                            class="survey-q-grid-collegend survey-q-grid-group-collegend customRight">
                            <span style="font-size: medium;">Considerar interesse, disponibilidade, conhecimento técnico, sugestões de aplicações.</span>
                        </th>
                    ...
                    <tr class="even colCount-11">
                        ...
                        <td headers="q2_c1 q2_cg1" style="display: none"
                            class="element groupingRows customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a1_8" id="a1_8" value="0"/>
                        </td>
                        <td headers="q2_c2 q2_cg1"
                            class="element groupingRows customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a1_8" id="a1_8" value="1"/>
                        </td>
                        <td headers="q2_c3 q2_cg2"
                            class="element groupingRows customLeft customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a1_8" id="a1_8" value="2"/>
                        </td>
                        <td headers="q2_c4 q2_cg2"
                            class="element groupingRows customLeft customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a1_8" id="a1_8" value="3"/>
                        </td>
                        <td headers="q2_c5 q2_cg2"
                            class="element groupingRows customLeft customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a1_8" id="a1_8" value="4"/>
                        </td>
        ...
        <div id="question_q2" class="survey-q surveyQuestion radio label_q2  ">
            <div class="question titulopage survey-q-question">
                <h2 title="Pergunta" class="survey-q-question-text"> 1.9 - Atendimento as emergências:</h2>
            </div>
            <!-- /.question -->
            ...
            <div class="answers survey-q-answers">
                <table class="grid survey-q-grid survey-q-grid-borders"
                    ...
                    <tr class="legend colGroup">
                        ...
                        <th colspan="5" id="q2_cg1"
                            class="survey-q-grid-collegend survey-q-grid-group-collegend customRight">
                            <span style="font-size: medium;">Considerar a disponibilidade e a agilidade nas tomadas de ações.</span>
                        </th>
                    ...
                    <tr class="even colCount-11">
                        ...
                        <td headers="q2_c1 q2_cg1" style="display: none"
                            class="element groupingRows customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a1_9" id="a1_9" value="0"/>
                        </td>
                        <td headers="q2_c2 q2_cg1"
                            class="element groupingRows customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a1_9" id="a1_9" value="1"/>
                        </td>
                        <td headers="q2_c3 q2_cg2"
                            class="element groupingRows customLeft customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a1_9" id="a1_9" value="2"/>
                        </td>
                        <td headers="q2_c4 q2_cg2"
                            class="element groupingRows customLeft customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a1_9" id="a1_9" value="3"/>
                        </td>
                        <td headers="q2_c5 q2_cg2"
                            class="element groupingRows customLeft customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a1_9" id="a1_9" value="4"/>
                        </td>
                ...
                <table class="grid survey-q-grid survey-q-grid-borders"
                    ...
                    <tr class="legend colGroup">
                        ...
                        <th colspan="5" id="q2_cg1"
                            class="survey-q-grid-collegend survey-q-grid-group-collegend customRight">
                            <span
                                style="font-size: medium;">Considerar o desenvolvimento do produto e as inovações.</span>
                        </th>
                    ...
                    <tr class="even colCount-11">
                        ...
                        <td headers="q2_c1 q2_cg1" style="display: none"
                            class="element groupingRows customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a2_1" id="a2_1" value="0"/>
                        </td>
                        <td headers="q2_c2 q2_cg1"
                            class="element groupingRows customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a2_1" id="a2_1" value="1"/>
                        </td>
                        <td headers="q2_c3 q2_cg2"
                            class="element groupingRows customLeft customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a2_1" id="a2_1" value="2"/>
                        </td>
                        <td headers="q2_c4 q2_cg2"
                            class="element groupingRows customLeft customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a2_1" id="a2_1" value="3"/>
                        </td>
                        <td headers="q2_c5 q2_cg2"
                            class="element groupingRows customLeft customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a2_1" id="a2_1" value="4"/>
                        </td>
        ...
        <div id="question_q2" class="survey-q surveyQuestion radio label_q2  ">
            <div class="question titulopage survey-q-question">
                <h2 title="Pergunta" class="survey-q-question-text"> 2.2 - Suporte técnico - (Engenharia):</h2>
            </div>
            <!-- /.question -->
            ...
            <div class="answers survey-q-answers">
                <table class="grid survey-q-grid survey-q-grid-borders"
                    ...
                    <tr class="legend colGroup">
                        ...
                        <th colspan="5" id="q2_cg1"
                            class="survey-q-grid-collegend survey-q-grid-group-collegend customRight">
                            <span style="font-size: medium;">Considerar a qualidade das informações técnicas</span>
                        </th>
                    ...
                    <tr class="even colCount-11">
                        ...
                        <td headers="q2_c1 q2_cg1" style="display: none"
                            class="element groupingRows customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a2_2" id="a2_2" value="0"/>
                        </td>
                        <td headers="q2_c2 q2_cg1"
                            class="element groupingRows customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a2_2" id="a2_2" value="1"/>
                        </td>
                        <td headers="q2_c3 q2_cg2"
                            class="element groupingRows customLeft customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a2_2" id="a2_2" value="2"/>
                        </td>
                        <td headers="q2_c4 q2_cg2"
                            class="element groupingRows customLeft customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a2_2" id="a2_2" value="3"/>
                        </td>
                        <td headers="q2_c5 q2_cg2"
                            class="element groupingRows customLeft customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a2_2" id="a2_2" value="4"/>
                        </td>
        ...
        <div id="question_q2" class="survey-q surveyQuestion radio label_q2  ">
            <div class="question titulopage survey-q-question">
                <h2 title="Pergunta" class="survey-q-question-text"> 2.3 - Atendimento as especificações:</h2>
            </div>
            <!-- /.question -->
            ...
            <div class="answers survey-q-answers">
                <table class="grid survey-q-grid survey-q-grid-borders"
                    ...
                    <tr class="legend colGroup">
                        ...
                        <th colspan="5" id="q2_cg1"
                            class="survey-q-grid-collegend survey-q-grid-group-collegend customRight">
                            <span style="font-size: medium;">Considerar a capacidade de atender as especificações requeridas.</span>
                        </th>
                    ...
                    <tr class="even colCount-11">
                        ...
                        <td headers="q2_c1 q2_cg1" style="display: none"
                            class="element groupingRows customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a2_3" id="a2_3" value="0"/>
                        </td>
                        <td headers="q2_c2 q2_cg1"
                            class="element groupingRows customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a2_3" id="a2_3" value="1"/>
                        </td>
                        <td headers="q2_c3 q2_cg2"
                            class="element groupingRows customLeft customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a2_3" id="a2_3" value="2"/>
                        </td>
                        <td headers="q2_c4 q2_cg2"
                            class="element groupingRows customLeft customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a2_3" id="a2_3" value="3"/>
                        </td>
                        <td headers="q2_c5 q2_cg2"
                            class="element groupingRows customLeft customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a2_3" id="a2_3" value="4"/>
                        </td>
        ...
        <div id="question_q2" class="survey-q surveyQuestion radio label_q2  ">
            <div class="question titulopage survey-q-question">
                <h2 title="Pergunta" class="survey-q-question-text"> 2.4 - Qualidade do produto:</h2>
            </div>
            <!-- /.question -->
            ...
            <div class="answers survey-q-answers">
                <table class="grid survey-q-grid survey-q-grid-borders"
                    ...
                    <tr class="even colCount-11">
                        ...
                        <td headers="q2_c1 q2_cg1" style="display: none"
                            class="element groupingRows customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a2_4" id="a2_4" value="0"/>
                        </td>
                        <td headers="q2_c2 q2_cg1"
                            class="element groupingRows customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a2_4" id="a2_4" value="1"/>
                        </td>
                        <td headers="q2_c3 q2_cg2"
                            class="element groupingRows customLeft customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a2_4" id="a2_4" value="2"/>
                        </td>
                        <td headers="q2_c4 q2_cg2"
                            class="element groupingRows customLeft customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a2_4" id="a2_4" value="3"/>
                        </td>
                        <td headers="q2_c5 q2_cg2"
                            class="element groupingRows customLeft customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a2_4" id="a2_4" value="4"/>
                        </td>
        ...
        <div id="question_q2" class="survey-q surveyQuestion radio label_q2  ">
            <div class="question titulopage survey-q-question">
                <h2 title="Pergunta" class="survey-q-question-text"> 2.5 - Embalagem e acondicionamento:</h2>
            </div>
            <!-- /.question -->
            ...
            <div class="answers survey-q-answers">
                <table class="grid survey-q-grid survey-q-grid-borders"
                    ...
                    <tr class="legend colGroup">
                        ...
                        <th colspan="5" id="q2_cg1"
                            class="survey-q-grid-collegend survey-q-grid-group-collegend customRight">
                            <span style="font-size: medium;">Considerar a preocupação com a integridade do produto e a praticidade de manuseio.</span>
                        </th>
                    ...
                    <tr class="even colCount-11">
                        ...
                        <td headers="q2_c1 q2_cg1" style="display: none"
                            class="element groupingRows customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a2_5" id="a2_5" value="0"/>
                        </td>
                        <td headers="q2_c2 q2_cg1"
                            class="element groupingRows customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a2_5" id="a2_5" value="1"/>
                        </td>
                        <td headers="q2_c3 q2_cg2"
                            class="element groupingRows customLeft customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a2_5" id="a2_5" value="2"/>
                        </td>
                        <td headers="q2_c4 q2_cg2"
                            class="element groupingRows customLeft customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a2_5" id="a2_5" value="3"/>
                        </td>
                        <td headers="q2_c5 q2_cg2"
                            class="element groupingRows customLeft customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a2_5" id="a2_5" value="4"/>
                        </td>
        ...
        <div id="question_q2" class="survey-q surveyQuestion radio label_q2  ">
            <div class="question titulopage survey-q-question">
                <h2 title="Pergunta" class="survey-q-question-text"> 2.6 - Transporte:</h2>
            </div>
            <!-- /.question -->
            ...
            <div class="answers survey-q-answers">
                <table class="grid survey-q-grid survey-q-grid-borders"
                    ...
                    <tr class="legend colGroup">
                        ...
                        <th colspan="5" id="q2_cg1"
                            class="survey-q-grid-collegend survey-q-grid-group-collegend customRight">
                            <span style="font-size: medium;">Considerar cuidados com a carga, documentos e condições da embalagem.</span>
                        </th>
                    ...
                    <tr class="even colCount-11">
                        ...
                        <td headers="q2_c1 q2_cg1" style="display: none"
                            class="element groupingRows customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a2_6" id="a2_6" value="0"/>
                        </td>
                        <td headers="q2_c2 q2_cg1"
                            class="element groupingRows customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a2_6" id="a2_6" value="1"/>
                        </td>
                        <td headers="q2_c3 q2_cg2"
                            class="element groupingRows customLeft customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a2_6" id="a2_6" value="2"/>
                        </td>
                        <td headers="q2_c4 q2_cg2"
                            class="element groupingRows customLeft customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a2_6" id="a2_6" value="3"/>
                        </td>
                        <td headers="q2_c5 q2_cg2"
                            class="element groupingRows customLeft customRight    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a2_6" id="a2_6" value="4"/>
                        </td>
        ...
        <!--3.1-->
        <!-- /.surveyQuestion -->
        <div id="question_q3" class="survey-q surveyQuestion radio label_q3  ">
            <div class="question titulopage survey-q-question">
                <h2 title="Pergunta" class="survey-q-question-text">
                    <div class="demo-header"></div>
                    3.1 - Você recomendaria nossos produtos e serviços?
                </h2>
            </div>
            <!-- /.question -->
            ...
            <!-- /.instructions -->
            <div class="answers survey-q-answers">
                <table class="grid survey-q-grid survey-q-grid-borders specifiedWidths"
                       summary="This table contains form elements to answer the survey question">
                    <tr class="legend top-legend colCount-5">

                        <th id="q3_c1" class="legend survey-q-grid-collegend  " style="width:80px; min-width:80px">
                            <span style="font-size: medium;">Sim</span>
                        </th>
                        <th id="q3_c2" class="legend survey-q-grid-collegend  " style="width:80px; min-width:80px">
                            <span style="font-size: medium;">Não</span>
                        </th>

                    </tr>
                    <tbody>
                    <tr class="even colCount-5">

                        <td headers="q3_c1" class="element groupingRows    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a3_1" id="a3_1" value="1"/>
                        </td>


                        <td headers="q3_c1" class="element groupingRows    clickableCell survey-q-grid-cell-clickable">
                            <input type="radio" name="a3_1" id="a3_1" value="0"/>
                        </td>
        ...
        <div id="question_q5" style="width: 96% !important;" class="survey-q surveyQuestion number label_q5  ">
            <div class="question titulopage survey-q-question">
                <h2 title="Pergunta" class="survey-q-question-text"> 3.2 - Quantos equipamentos sua empresa adquire
                    mensalmente?</h2>
            </div>
            <!-- /.question -->

            <div class="instructions survey-q-instructions">
                <h3 title="Instrução" class="survey-q-instructions-text">Entre com um Valor Numérico</h3>
            </div>
            <!-- /.instructions -->
            <div class="answers survey-q-answers">
                <table class="grid survey-q-grid survey-q-grid-borders"
                    ...
                    <tr class="even colCount-1">
                        ...
                        <td headers="" class="element groupingRows OneColumnEl   ">
                            <input type="number" min="0" max="999" name="a3_2" id="a3_2" size="10" class="text" onkeypress='return SomenteNumero(event)'/>
                        </td>
...
if ((isset($_POST['a1_1'])) AND (isset($_POST['a1_2'])) AND (isset($_POST['a1_3'])) AND (isset($_POST['a1_4'])) AND (isset($_POST['a1_5'])) AND (isset($_POST['a1_6'])) AND (isset($_POST['a1_7'])) AND (isset($_POST['a1_8'])) AND (isset($_POST['a1_9'])) AND (isset($_POST['a2_1'])) AND (isset($_POST['a2_2'])) AND (isset($_POST['a2_3'])) AND (isset($_POST['a2_4'])) AND (isset($_POST['a2_5'])) AND (isset($_POST['a2_6'])) AND (isset($_POST['a3_1'])) AND (isset($_POST['a3_2'])) AND (($_POST['a1_1'] !== "")) AND (($_POST['a1_2'] !== "")) AND (($_POST['a1_3'] !== "")) AND (($_POST['a1_4'] !== "")) AND (($_POST['a1_5'] !== "")) AND (($_POST['a1_6'] !== "")) AND (($_POST['a1_7'] !== "")) AND (($_POST['a1_8'] !== "")) AND (($_POST['a1_9'] !== "")) AND (($_POST['a2_1'] !== "")) AND (($_POST['a2_2'] !== "")) AND (($_POST['a2_3'] !== "")) AND (($_POST['a2_4'] !== "")) AND (($_POST['a2_5'] !== "")) AND (($_POST['a2_6'] !== "")) AND (($_POST['a3_1'] !== ""))) {
    ...
    $sql_insert = "INSERT INTO pesquisa (atend_telefone,atend_representante,atend_vendas,atend_catal_site,facil_negocios,preco_produto,prazo_entrega,pos_venda,atend_emergencia,nivel_tecnologico,suporte_tecnico,atend_especificacoes,qualidade_produto,embalagem,transporte,recomendacao,equip_adquirido,uf,ano) VALUES ('$a1_1','$a1_2','$a1_3','$a1_4','$a1_5','$a1_6','$a1_7','$a1_8','$a1_9','$a2_1','$a2_2','$a2_3','$a2_4','$a2_5','$a2_6','$a3_1','$a3_2','$ufBanco','$periodo')";
    ...
    $m = '
    	<html>
    		...
    		<tr>
    		  ...
    		  <tr>
    			<td>
    				<b>1.3 - Vendas (atendimento interno):</b>
    			</td>
    		  </tr>
    		  <tr>
    			<td>
    		  ...
    		  <tr>
    			<td>
    				<b>1.5 - Facilidade em realizar negócios:</b>
    			</td>
    		  </tr>
    		  <tr>
    			<td>
    		  ...
    		  <tr>
    			<td>
    				<b>1.7 - Cumprimento dos prazos de entrega:</b>
    			</td>
    		  </tr>
    		  <tr>
    			<td>
    		  ...
    		  <tr>
    		  		  ...
    		  		  <tr>
    		  			<td>
    		  				<b>1.9 - Atendimento as emergências:</b>
    		  			</td>
    		  		  </tr>
    		  <tr>
    		  			<td>
    		  		  ...
    		  		  <tr>
    			<td>
    				<b>2. Qualidade dos Produtos e Serviços</b>
    			</td>
    		  </tr>
    		  		  <tr>
    			<td>
    				<b>2.1 - Nível tecnológico: </b>
    			</td>
    		  </tr>
    		  <tr>
    			<td>
    		  ...
    		  <tr>
    			<td>
    				<b>2.2 - Suporte técnico - (Engenharia):</b>
    			</td>
    		  </tr>
    		  <tr>
    			<td>
    				<b>Nota:</b> ' . $a2_2 . '<br/><br/>
                      ...
                      <tr>
    			<td>
    				<b>2.3 - Atendimento as especificações:</b>
    			</td>
    		  </tr>
    		  <tr>
    			<td>
    		  ...
    		  <tr>
    			<td>
    				<b>2.5 - Embalagem e acondicionamento:</b>
    			</td>
    		  </tr>
    		  <tr>
    			<td>
    		  ...
    		  <tr>
    		  			<td>
    		  				<b>3.1 - Você recomendaria nossos produtos e serviços? </b>
    		  			</td>
    		  		  </tr>
    		  <tr>
    		  			<td>
    		  		  ...
    		  		  <tr>
    		  			<td>
    		  				<b>3.2 - Quantos equipamentos sua empresa adquire mensalmente?</b>
    		  			</td>
    		  		  </tr>
    		  <tr>
    		  			<td>
    		  		  ...
    		  		  <tr>
    		  			<td>
    		  				<b>3.3 - Há algum novo produto que gostaria de desenvolver? Qual?</b>
    		  			</td>
    		  		  </tr>
    		  <tr>
    		  			<td>
