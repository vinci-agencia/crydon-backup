...
if(isset($_POST['busca'])){
	...
	$busca = $_POST['busca'];	
	$sql = "SELECT nome,id_estado,endereco,id,ordem,telefone FROM onde_comprar WHERE nome LIKE '%".$busca."%' AND id_estado = ".$idestado." ORDER BY ordem ASC LIMIT $inicial, $numreg";
	...
	$id_est = @$_GET['id_est'];
        $sql = "select nome,id_estado,endereco,id,ordem,telefone from onde_comprar where endereco LIKE '%".$_POST['buscaC']."%' order by endereco ASC LIMIT $inicial, $numreg";   
	$sql_conta = mysql_query("SELECT id FROM onde_comprar where endereco LIKE '%".$_POST['buscaC']."%'");
}
else{
	$id_est = @$_GET['id_est'];
	$sql = "SELECT nome,id_estado,endereco,id,ordem,telefone FROM onde_comprar WHERE id_estado = '$id_est' ORDER BY ordem ASC LIMIT $inicial, $numreg";
