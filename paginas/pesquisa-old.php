...
if ((isset($_POST['a1_1'])) AND (isset($_POST['a1_2'])) AND (isset($_POST['a1_6'])) AND (isset($_POST['a1_7'])) AND (isset($_POST['a2_2'])) AND (isset($_POST['a2_4'])) AND (isset($_POST['a2_5'])) AND (isset($_POST['a3_2'])) AND (($_POST['a1_1'] !== "")) AND (($_POST['a1_2'] !== "")) AND (($_POST['a1_6'] !== "")) AND (($_POST['a1_7'] !== "")) AND (($_POST['a2_2'] !== "")) AND (($_POST['a2_4'] !== "")) AND (($_POST['a2_5'] !== ""))) {
    ...
    $sql_insert = "INSERT INTO pesquisa (atend_telefone,atend_representante,preco_produto,preco_comparado,prazo_entrega,suporte_tecnico,qualidade_produto,equip_adquirido,uf,ano) VALUES ('$a1_1','$a1_2','$a1_6','$a1_7','$a2_2','$a2_4','$a2_5','$a3_2','$ufBanco','$periodo')";
    ...
    $m = '
    	<html>
    		...
    		<tr>
              ...
              <tr>
    			<td>
    				<b> 1.7 - Preço coparativo do produto:</b>
    			</td>
    		  </tr>
    		  <tr>
    			<td>
