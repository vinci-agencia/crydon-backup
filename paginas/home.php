...
<script type="text/javascript">
  ...
  (function() {
    ...
    _paq.push(['setSiteId', 21485]);
    var d=document, g=d.createElement('script'), s=d.getElementsByTagName('script')[0];
    g.type='text/javascript'; g.async=true; g.defer=true; g.src=u+'piwik.js'; s.parentNode.insertBefore(g,s);
  })();
</script>
<noscript><p><img src="//cluster-piwik.locaweb.com.br/piwik.php?idsite=21485" style="border:0;" alt="" /></p></noscript>
<!-- End Piwik Code -->
                        ...
                        <div class="box-texto-empresa">
                            <?php if($lang == 'pt'){ ?>
                                ...
                                <div style="display: none;" class="empresa-hidden-pt">
                                    ...
                                    <p>* <strong>Missão:</strong> Fabricar equipamentos para cozinhas profissionais adequados e confiáveis, que entreguem a funcionalidade prometida gerando rentabilidade à toda cadeia produtiva: Fábrica / Distribuidor / Consumidor Final.</p>
                                    <p>* <strong>Visão:</strong> Alcançar a satisfação do usuário com nossos equipamentos. 
- Liderar o mercado nacional.<br>
    - Expansão no mercado exterior.</p>
    <p>* <strong>Valores:</strong>  - Funcionalidade / Segurança / Qualidade;<br>
- Honestidade;<br>
- Comprometimento;<br>
- Respeito. </p>
                            </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="box-botoes-empresa2">
                            ...
                            <a data-toggle="modal" data-target="#modal-videoinstitucional" class="bt-videoinstitucional" href="javascript:void(0);">Vídeo Institucional</a>
                            <?php } elseif ($lang == 'es') { ?>
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                ...
                <?php } elseif ($lang == 'es') { ?>
                    ...
                    <div class="col-md-4 col-sm-4">
                        <a class="bt-home-linha" href="<?php echo $_SESSION['url'].$lang.'/vitrines/croydon';?>">
                            <img src="<?php echo $_SESSION['url'];?>images/icone_linhaquentegas.png" alt="Línea Caliente - Gas" />
                        </a>
...
<div class="modal fade" id="modal-videoinstitucional" tabindex="-1" role="dialog" aria-labelledby="modal-videoinstitucional">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">Vídeo Institucional</h4>
            </div>
            <div class="modal-body">
                <div class="embed-responsive embed-responsive-16by9">
                    <?php
