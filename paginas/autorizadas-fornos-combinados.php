	...
	<div class="row">
           <div class="col-md-5 col-sm-5">
			...
			<ul class="estados">
				...
				?>
				<div class="col-md-6">
                        <a class="btn btn-success link-estados <?php echo ($estados['id'] == @$url4 ? 'link-estados-selected' : ''); ?>" href="<?php echo $_SESSION['url'].$lang.'/conteudo/autorizadas-fornos-combinados/'.$estados['id'];?>"><?php echo $estados['nome'];?></a>
                    </div>
				<?php
					}
				 }
